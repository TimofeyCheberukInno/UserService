...
import static com.app.impl.unit.service.card.support.CardServiceTestData.CARD_EXPIRATION_DATE;
import static com.app.impl.unit.service.card.support.CardServiceTestData.CARD_HOLDER_NAME;
import static com.app.impl.unit.service.card.support.CardServiceTestData.CARD_ID;
import static com.app.impl.unit.service.card.support.CardServiceTestData.CARD_NUMBER;
import static com.app.impl.unit.service.card.support.CardServiceTestData.USER_BIRTHDATE;
import static com.app.impl.unit.service.card.support.CardServiceTestData.USER_EMAIL;
import static com.app.impl.unit.service.card.support.CardServiceTestData.USER_ID;
import static com.app.impl.unit.service.card.support.CardServiceTestData.USER_NAME;
import static com.app.impl.unit.service.card.support.CardServiceTestData.USER_SURNAME;
...
public class CardServiceTestConstants {
	...
	public static List<CardDto> getFullListOfCardDtos() {
		return new ArrayList<>(Arrays.asList(getCardDto1(), getCardDto2(), getCardDto3()));
	}
	...
	public static List<Card> getFullListOfCardsWithoutUsers() {
		return new ArrayList<>(Arrays.asList(getCard1(), getCard2(), getCard3()));
	}
	...
	public static Card getCard1WithUser() {
		return new Card(
                ...
                new User(
                        ...
                        "NAME_1",
                        "SURNAME_1",
                        LocalDate.of(2000, 10, 10), "email1@gmail.com"),
				"4263986527583938",
                "NAME_1 SURNAME_1",
                LocalDate.of(2003, 10, 23
                )
	...
	public static List<Card> getFullListOfCardsWithUsers() {
		return new ArrayList<>(Arrays.asList(getCard1WithUser(), getCard2WithUser(), getCard3WithUser()));
	}
	...
	public static List<CardWithUserDto> getFullListOfCardDtosWithUsers() {
		return new ArrayList<>(Arrays.asList(getCardDto1WithUser(), getCardDto2WithUser(), getCardDto3WithUser()));
	}
