...
public class CardServiceTest {
    ...
    class createCardTests {
        ...
        void shouldThrowUserNotFoundException() {
            ...
            Assertions.assertThatExceptionOfType(UserNotFoundException.class).isThrownBy(() -> { cardService.create(getCreateCardDto()); })
    ...
    class updateCardTests {
        ...
        void shouldThrowCardNotFoundException() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.update(getUpdateCardDto()); })
    ...
    class deleteCardTests {
        ...
        void shouldThrowCardNotFoundException() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.delete(CARD_ENTITY_ID); })
                            .withMessage(CARD_NOT_FOUND_BY_ID_MSG, CARD_ENTITY_ID);
    ...
    class findByIdTests {
        ...
        void shouldThrowCardNotFoundException() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.findById(CARD_ENTITY_ID); })
                    .withMessage(CARD_NOT_FOUND_BY_ID_MSG, CARD_ENTITY_ID);
        ...
        void shouldThrowCardNotFoundExceptionWithUser() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.findByIdWithUser(CARD_ENTITY_ID); })
                    .withMessage(CARD_NOT_FOUND_BY_ID_MSG, CARD_ENTITY_ID);
    ...
    class findByIdsTests {
        ...
        void shouldThrowCardNotFoundException() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.findByIds(getFullListOfIds()); })
        ...
        void shouldThrowCardNotFoundExceptionWithUsers() {
            ...
            Assertions.assertThatExceptionOfType(CardNotFoundException.class).isThrownBy(() -> { cardService.findByIdsWithUser(getFullListOfIds()); })
                            .withMessage(LIST_OF_CARDS_NOT_FOUND_BY_IDS_MSG + Arrays.asList(3L));
